...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		if(b.getText().equals("=")) {
			String[] loperacion=operacion.split("(?=\\D)|(?<=\\D)");
			if(loperacion[1].equals("+")) displayText.setText(String.valueOf(Double.parseDouble(loperacion[0])+Double.parseDouble(loperacion[2])));
			else if(loperacion[1].equals("-")) displayText.setText(String.valueOf(Double.parseDouble(loperacion[0])-Double.parseDouble(loperacion[2])));
			else if(loperacion[1].equals("*")) displayText.setText(String.valueOf(Double.parseDouble(loperacion[0])*Double.parseDouble(loperacion[2])));
			else if(loperacion[1].equals("/")) displayText.setText(String.valueOf(Double.parseDouble(loperacion[0])/Double.parseDouble(loperacion[2])));
			operacion="";
		}
